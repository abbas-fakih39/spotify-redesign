...
class HomeController extends Controller
{
    ...
    {
        // Données factices pour les tracks
        $tracks = [
        ...
        // Données factices pour les playlists
        $playlists = [
        ...
        // Vous pouvez laisser vide si vous préférez afficher "Vous n'avez pas encore créé de playlists"
        // $playlists = [];
